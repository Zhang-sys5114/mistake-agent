...
> **修订（2026-09-23，ADR-0045）**：本文「Responses API 不支持图片输入、视觉模型继续走 Chat Completions」的结论已过时——`deepseek-flash` 的 Responses API 原生支持 `input_image` 图片输入，视觉端点已退役，图片理解改走本适配器。
